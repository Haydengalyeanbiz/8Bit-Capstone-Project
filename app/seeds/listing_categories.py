...
def seed_listing_categories():
    ...
    listing_categories_data = [
        ...
        {'listing_id': 11, 'category_id': 6},
        {'listing_id': 11, 'category_id': 5},
        {'listing_id': 12, 'category_id': 6},
        {'listing_id': 12, 'category_id': 5},
        {'listing_id': 13, 'category_id': 1},
        {'listing_id': 13, 'category_id': 3},
        {'listing_id': 14, 'category_id': 1},
        {'listing_id': 14, 'category_id': 3},
        {'listing_id': 15, 'category_id': 1},
        {'listing_id': 15, 'category_id': 2},
        {'listing_id': 16, 'category_id': 1},
        {'listing_id': 16, 'category_id': 2},
        {'listing_id': 17, 'category_id': 1},
        {'listing_id': 17, 'category_id': 3},
        {'listing_id': 18, 'category_id': 5},
        {'listing_id': 18, 'category_id': 6},
